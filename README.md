...
7.  Existe, junto dos arquivos, um banco de dados SORTEIO.FDB. Banco sem tabelas criado em Firebird 5.0, com o usuário SYSDBA e senha masterkey. Existem procedures no programa que criam as tabelas.
